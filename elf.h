...
#define R_TRANSPUTER_JUMP_SLOT	22	/* Create PLT entry.  */
...
#define R_TRANSPUTER_64		36	/* Direct 64 bit.  */
#define R_TRANSPUTER_ABSOLUTE 37
#define R_TRANSPUTER_PC_RELATIVE 38
